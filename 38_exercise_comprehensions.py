...
def to_mod_list(employee_list):
    ...
    employee_department = map(mod, employee_list)
    # Convert the map object to a list
    employee_department = list(employee_department)
...
def generate_usernames(mod_list):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    usernames_list = [employee.replace(" ", "_") for employee in mod_list]
...
def map_id_to_initial(employee_list):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    # initials_dict = {employee["id"]: employee["name"][0] for employee in employee_list}
    initials_dict = {employee["name"][0]: employee["id"] for employee in employee_list}
