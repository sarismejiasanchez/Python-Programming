...
def test_length(input_value):
    ...
    assert spellcheck.word_count(input_value) < 10, "String has more than 10 words"
    assert spellcheck.char_count(input_value) < 50, "String has more than 50 characters"
    return
